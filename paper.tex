...
arrays~\cite{numpy}. Therefore, it uses all the infrastructure built by that
project for storing information. However, its inner loops are implemented in
\cpp{} for speed and ease of implementation.
