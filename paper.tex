...
the user is often exploring and is willing to pay the cost of a few extra type
conversions to avoid a hard-crash.
...
grant from the Scaife Foundation, by the HHMI Interface initial, and by a grant
