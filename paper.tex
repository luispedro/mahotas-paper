...
Processing can generate floating point images, for example, subtracting the
mean value to every pixel; the mean will be a floating point number even if the
...
meaningful and be more flexible without completely losing type checking.
